...
import { CopyData, Template, Project } from '/src/types/ProjectTypes'
import { StoredProject } from '/src/stores/useProjectStore'
import { PASTE_POSITION_OFFSET } from '/src/config/rendering'

import { useProjectsStore, useProjectStore, useViewStore, useTemplatesStore, useTemplateStore } from '/src/stores'
