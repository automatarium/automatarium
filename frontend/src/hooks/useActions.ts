...
import { CopyData, FSAModuleGraph, Module } from '/src/types/ProjectTypes'
...
export const selectionToCopyTemplate = (stateIds: number[], commentIds: number[], transitionIds: number[], project: Module): CopyData => {
