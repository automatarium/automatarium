const Logo = ({
  ...
  <svg
    ...
    {...props}
  >
    <circle fill={secondary} cx="241.33" cy="241.33" r="173.99"/>
    <path fill={secondary} d="M375.28,386.46l7.05,49.68c1.15,8.07,11.02,11.37,16.78,5.6l42.64-42.64c5.76-5.76,2.47-15.64-5.6-16.78l-49.68-7.05c-6.52-.92-12.1,4.66-11.18,11.18Z"/>
