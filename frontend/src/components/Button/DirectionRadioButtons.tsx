import { DirectionRadioGroup, DirectionLabel, DirectionRadioInput } from './directionRadioButtonsStyle'
...
export const DirectionRadioButtons = ({ direction, setDirection, handleSave }: DirectionProps) => {
  return (
        <DirectionRadioGroup>
            <DirectionLabel>
                <DirectionRadioInput
