import {ReadSymbol, TMGraph, UnresolvedTMGraph} from './types'
 ...
 */
export const resolveTMGraph = (graph: UnresolvedTMGraph): TMGraph => {
  ...
  const transitions = graph.transitions
    ...
    .map(transition => ({...transition, readSymbol: expandReadSymbols(transition.readSymbol), readDirection: expandReadSymbols(transition.readDirection)}))
