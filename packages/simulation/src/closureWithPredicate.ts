 ...
 * ```
 */
export const closureWithPredicate = <P extends ModuleGraph, T extends TransitionMapping<P>>(graph: P, currentStateID: StateID, predicate: ClosureWithPredicateFn<T>): GraphClosure<T> => {
