 ...
 * ```
 */
export const closureWithPredicate = <P extends ModuleData, T extends TransitionMapping<P>>(graph: P, currentStateID: StateID, predicate: ClosureWithPredicateFn<T>): GraphClosure<T> => {
