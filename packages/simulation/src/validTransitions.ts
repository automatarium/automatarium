 ...
 */
export const validTransitions = <P extends ModuleGraph, T extends TransitionMapping<P>>(graph: P, currentStateID: StateID, nextRead: ReadSymbol): ValidTransition<T>[] => {
