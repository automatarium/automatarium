import {StateID, TMGraph, TMTransition} from './types'

export type ClosureNode = { transition: TMTransition, parents: TMTransition[] }
export type ClosureWithPredicateFn = (transition: TMTransition) => boolean
 ...
 * ```
 */
export const closureWithPredicateTM = (graph: TMGraph, currentStateID: StateID, predicate: ClosureWithPredicateFn): Set<[StateID, TMTransition[]]> => {
...
export default closureWithPredicateTM
