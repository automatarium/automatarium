...
import dibnfa1 from '../tests/graphs/dib-nfa.json'
import dibnfa2 from '../tests/graphs/dib-nfa2.json'
import dibnfa3 from '../tests/graphs/dib-nfa3.json'
import dibnfa4 from '../tests/graphs/dib-nfa4.json'
